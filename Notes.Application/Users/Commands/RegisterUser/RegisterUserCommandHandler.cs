...
namespace Notes.Application.Users.Commands.RegisterUser
{
    public class RegisterUserCommandHandler : IRequestHandler<RegisterUserCommand, UserDto>
    {
        ...
        public async Task<UserDto> Handle(RegisterUserCommand request, CancellationToken cancellationToken)
        {
            ...
            var savedUserAndToken = await CreateNewUserAndSave(request);
            return MapToDto(savedUserAndToken);
        }
            ...
            (RegisterUserCommand request)
        {
            ...
            User createdUser = await _usersHelper.SaveUserAsync(newUser, _cancellationToken);
